...
export function DemoChatSection() {
  return (
    <section id="voice-demo" className="border-b px-4 py-16 sm:px-6 lg:px-8 jarq-border">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[360px_1fr]">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold sm:text-4xl">Диалог, который помнит ученика</h2>
        ...
        <div className="rounded-2xl p-4 jarq-glass">
