...
export function LearningTracksSection() {
  return (
    <section id="tracks" className="border-b px-4 py-14 sm:px-6 sm:py-18 lg:px-8 jarq-border">
          ...
          {learningTracks.map((track, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={track.href}
                  className="button-lift group relative block min-h-[300px] overflow-hidden rounded-3xl border p-6 transition hover:-translate-y-1 hover:border-cyan-300/60 jarq-glass sm:p-8"
                >
