...
export const uiText = {
  ru: {
    ...
    themeNight: "Ночь",
    lang: "RU",
    intro: "Привет, я Хана — твой AI репетитор 💙",
    support: "Поддержка",
    tutor: "Репетитор",
    supportHint: "Спроси Хану о проекте, уроках или настройках.",
  },
  en: {
    ...
    themeNight: "Night",
    lang: "EN",
    intro: "Hi, I’m Hana — your AI tutor 💙",
    support: "Support",
    tutor: "Tutor",
    supportHint: "Ask Hana about the product, lessons, or setup.",
  },
};
